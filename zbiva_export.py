...
if __name__ == "__main__":
    ...
    print("Save artifacts CSV")
    artifacts_df = pd.DataFrame(artifacts_csv_dict)
    artifacts_df.to_csv('csv/artifacts.csv', index=False)
    print(
        f"Artifacts processing: {time.time() - start_artifacts:.2f} seconds")
